    ...
    <>
      ...
      <main className="overflow-x-hidden">
        <section className="pt-16 sm:pt-24 md:pt-32">
          <div className="w-full relative mx-auto px-4 sm:px-8 md:px-16 lg:px-28 max-w-full">
        ...
        <section className="mb-16 sm:mb-32 md:mb-64 overflow-x-hidden">
          <div className="relative !mx-auto px-4 sm:px-8 md:px-16 lg:px-28 max-w-full">
